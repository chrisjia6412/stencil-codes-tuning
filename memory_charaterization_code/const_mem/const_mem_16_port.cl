...
{  
    ...
    for(int i=0; i<67108864; i++) {
  	...
  	temp_value_8 = srcMatrix[temp_value_8];
  	temp_value_9 = srcMatrix[temp_value_9];
  	temp_value_10 = srcMatrix[temp_value_10];
  	temp_value_11 = srcMatrix[temp_value_11];
  	temp_value_12 = srcMatrix[temp_value_12];
  	temp_value_13 = srcMatrix[temp_value_13];
	temp_value_14 = srcMatrix[temp_value_14];
  	temp_value_15 = srcMatrix[temp_value_15];
